...
void LookupSingleHands()
{
    ...
    int cards[] = {52, 48, 44, 40, 36, 39, 32};
...
void EnumerateAll7CardHands()
{
    ...
    printf("\nEnumerated %d hands in %ld milliseconds!\n", count, duration);
}
...
int main()
{
    ...
    FILE * fin = fopen("/mnt/c/Users/eddie/Documents/Poker Engine/poker-engine/src/HandRanks.dat", "rb");
    if (!fin) {
        printf("Failed to load HandRanks.dat file\n");
        return 1;
    }
